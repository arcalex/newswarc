...
db_path = 'newswarc.db'  # Replace with the actual path to your database
...
if filter_option == "Filter by Time":
    start_date = st.date_input("Start Date", value=datetime(2016, 9, 26))
    start_time = st.time_input("Start Time", value=datetime(2016, 9, 26, 21, 17, 51).time())
